	...
	factory: (require) => {
		...
		*/
		...
		function navIcon(id) {
			...
			if (id === "account") return (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconUserOutline16, {
				className: SettingsRoot_module_css_default.navIcon,
				size: 16
			});
		...
		*/
		...
		/** Account-section inline styles (DSW alias tokens so they follow the active theme). */
		const accountSectionStyle$1 = { display: "flex", flexDirection: "column", gap: "20px" };
		const accountBlockStyle = { display: "flex", flexDirection: "column", gap: "8px" };
		const accountTitleStyle = { color: "var(--dsw-alias-label-primary)", fontSize: "15px", fontWeight: "500", lineHeight: "22px" };
		const accountValueStyle = { color: "var(--dsw-alias-label-primary)", fontSize: "20px", fontWeight: "600", lineHeight: "28px" };
		const accountRowStyle = { display: "flex", alignItems: "center", justifyContent: "space-between", gap: "12px", padding: "10px 0", borderBottom: "1px solid var(--dsw-alias-divider-strong)", fontSize: "14px", lineHeight: "22px" };
		const accountMutedStyle = { color: "var(--dsw-alias-label-tertiary)", fontSize: "13px", lineHeight: "20px" };
		const accountErrorStyle = { color: "var(--dsw-alias-state-error-primary)", fontSize: "13px", lineHeight: "20px" };
		const accountLinkStyle = { color: "var(--dsw-alias-interactive-primary)", textDecoration: "none", fontSize: "14px", lineHeight: "22px" };
		/** DeepSeek top-up / sign-in page (opened in the system browser by the Tauri webview). */
		const DEEPSEEK_TOP_UP_URL = "https://platform.deepseek.com/top_up";
		/**
		* Account section: DeepSeek balance, cumulative local token usage across all
		* sessions, and a top-up/sign-in link. Balance comes from the host-side
		* `balance.get` remote; token usage is summed from each session.list row's
		* `tokenUsage` projection.
		* @param props - injected connection face and bound dictionary.
				...
				children: [(0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsxs)("div", {
						...
						children: [(0, react_jsx_runtime.jsx)("span", {
							...
							children: t("account.balanceTitle")
						}), (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								...
								onClick: () => {
									connection.api.host.openExternal({ url: DEEPSEEK_TOP_UP_URL }).catch(() => void 0);
								},
					...
					}), snapshot.status === "loading" ? (0, react_jsx_runtime.jsx)("div", {
						style: accountMutedStyle,
						children: t("account.balanceLoading")
					}) : snapshot.status === "error" ? (0, react_jsx_runtime.jsxs)("div", {
						style: accountBlockStyle,
						children: [(0, react_jsx_runtime.jsx)("div", {
							style: accountErrorStyle,
							children: t("account.balanceError")
						}), snapshot.error === null ? null : (0, react_jsx_runtime.jsx)("div", {
							style: accountMutedStyle,
							children: snapshot.error
						}), snapshot.errorCode === "missing-credential" ? (0, react_jsx_runtime.jsx)("div", {
							style: accountMutedStyle,
							children: t("account.notConfigured")
						}) : null]
					}) : (0, react_jsx_runtime.jsx)("div", {
						style: accountBlockStyle,
						children: snapshot.balance === null || snapshot.balance.balance_infos.length === 0 ? (0, react_jsx_runtime.jsx)("div", {
							style: accountMutedStyle,
							children: t("account.balanceLoading")
						}) : snapshot.balance.balance_infos.map((info) => (0, react_jsx_runtime.jsxs)("div", {
							key: info.currency,
							style: accountRowStyle,
							children: [(0, react_jsx_runtime.jsx)("span", {
								children: info.currency
							}), (0, react_jsx_runtime.jsx)("span", {
								style: accountValueStyle,
								children: info.total_balance
							})]
						}))
					})]
				}), (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [(0, react_jsx_runtime.jsx)("span", {
						style: accountTitleStyle,
						children: t("account.tokenTitle")
					}), snapshot.tokens === null ? (0, react_jsx_runtime.jsx)("div", {
						style: accountMutedStyle,
						children: t("account.balanceLoading")
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							style: accountRowStyle,
							children: [(0, react_jsx_runtime.jsx)("span", {
								children: t("account.tokenInput")
							}), (0, react_jsx_runtime.jsx)("span", {
								children: snapshot.tokens.input.toLocaleString()
							})]
						}), (0, react_jsx_runtime.jsxs)("div", {
							style: accountRowStyle,
							children: [(0, react_jsx_runtime.jsx)("span", {
								children: t("account.tokenOutput")
							}), (0, react_jsx_runtime.jsx)("span", {
								children: snapshot.tokens.output.toLocaleString()
							})]
						}), (0, react_jsx_runtime.jsxs)("div", {
							style: accountRowStyle,
							children: [(0, react_jsx_runtime.jsx)("span", {
								children: t("account.tokenCacheRead")
							}), (0, react_jsx_runtime.jsx)("span", {
								children: snapshot.tokens.cacheRead.toLocaleString()
							})]
						}), (0, react_jsx_runtime.jsxs)("div", {
							style: accountRowStyle,
							children: [(0, react_jsx_runtime.jsx)("span", {
								children: t("account.tokenCacheWrite")
							}), (0, react_jsx_runtime.jsx)("span", {
								children: snapshot.tokens.cacheWrite.toLocaleString()
							})]
						}), (0, react_jsx_runtime.jsxs)("div", {
							style: Object.assign({}, accountRowStyle, { borderBottom: "none", fontWeight: "600" }),
							children: [(0, react_jsx_runtime.jsx)("span", {
								children: t("account.tokenTotal")
							}), (0, react_jsx_runtime.jsx)("span", {
								children: tokensTotal.toLocaleString()
							})]
						})]
					})]
				})]
